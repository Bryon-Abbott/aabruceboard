...
class MessageTileProcessed extends StatelessWidget {
  final Message message;
  const MessageTileProcessed({super.key, required this.message});
  ...
  Future<void> messageAccept (BuildContext context) async {
    ...
    // *** Credits Request Message
      case 00020: {   // Membership Credit Request Message
        ...
        if ((message.data['creditDebit'] == 'debit') && (message.data['credits'] > member.credits )) {
          if (!context.mounted) return;
